...
namespace WebApiConfigurationn.Controllers.Auth
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(UserManager<Entities.Auth.AppUser<Guid>> userManager, RoleManager<IdentityRole> roleManager, IMapper mapper, IConfiguration configuration)
        {
        ...
        [HttpPost]
        public async  Task<IActionResult> Resgister(RegisterDTO register)
        {
